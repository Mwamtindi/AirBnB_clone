#!/usr/bin/python3
"""Defines unittests for place.py in models.
Unittest classes:
...
class TestPlace_instantiation(unittest.TestCase):
    """Unittests to test instantiation of place class."""
    ...
    def test_str_representation(self):
        ...
        place_instance.created_at = place_instance.updated_at = current_datetime
        place_str = place_instance.__str__()
        self.assertIn("[Place] (123456)", place_str)
        self.assertIn("'id': '123456'", place_str)
        self.assertIn("'created_at': " + current_datetime_repr, place_str)
        self.assertIn("'updated_at': " + current_datetime_repr, place_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        place_instance = Place(id="345", created_at=current_datetime_iso, updated_at=current_datetime_iso)
        self.assertEqual(place_instance.id, "345")
        self.assertEqual(place_instance.created_at, current_datetime)
        self.assertEqual(place_instance.updated_at, current_datetime)
...
class TestPlace_save(unittest.TestCase):
    """Unittests to test save method of place class."""
...
class TestPlace_to_dict(unittest.TestCase):
    """Unittests to test to_dict method of place class."""
